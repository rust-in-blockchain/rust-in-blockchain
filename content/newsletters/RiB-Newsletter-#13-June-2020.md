...
#### News
- [Enigma partners with IBM on "SafeTrace"](https://www.ibm.com/cloud/blog/enigma-and-ibm-cloud-are-protecting-human-lives-as-well-as-data-privacy), a contact tracing app. Enigma is a Rust blockchain with private computation.
...
#### Projects
- [blst](https://github.com/supranational/blst/). An implementation of BLS12-381. In C, with Rust bindings.
- [celo-bls-snark-rs](https://github.com/celo-org/celo-bls-snark-rs). Implements SNARK-friendly BLS signatures over BLS12-377 and BW6-761.
- [Candid](https://github.com/dfinity/candid), an interface description language (IDL) for interacting with canisters (also known as services or actors) running on the Internet Computer.
- [Crate Crypto](https://github.com/crate-crypto). Open source cryptographic implementations. Mostly from IACR.
...
- [Sigma Rust](https://github.com/ergoplatform/sigma-rust). Rust implementation of ErgoScript cryptocurrency scripting language.
- The [Stacks 2.0](https://github.com/blockstack/stacks-blockchain) blockchain implementation, an open-membership replicated state machine produced by the coordination of a non-enumerable set of peers.
- [Starcoin](https://github.com/starcoinorg/starcoin). A Layered Cryptocurrency and Decentralized Blockchain System.

#### Videos
- [ZkVM: About the motocrab](https://www.youtube.com/watch?v=1i-EJykVzag). ZkVM is a zero-knowledge VM created by Stellar.
