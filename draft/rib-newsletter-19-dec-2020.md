...
In RiB news, as we've mentioned in the past, sometimes we receive inquires about
purchasing ads in RiB. We want to try this, but also to ensure RiB remains a
welcoming place for technical discussion and news (not a cryptocurrency
...
the [RiB community fund][cfund] (as are 100% of donations via the cryptocurrency
addresses on the website). Details of the program [are on the website][spons].
This is our first time running such a program and feedback is welcome in the
[Telegram group][tg] or privately [by email][em].
